            ...
            <div>
                ...
                >
                    <div className="flex items-center">
                        <i className="fas fa-trophy mr-2.5 text-cyan-aura text-xs"></i>
                        <span className="truncate max-w-[150px]">{selectedTournament ? selectedTournament.name : `Season ${currentSeason}`}</span>
                    </div>
                    <i className={`fas fa-chevron-down ml-2 text-xs transition-transform duration-300 ${isOpen ? 'rotate-180 text-cyan-aura' : 'text-white/60'}`}></i>
                </button>
            </div>
                        ...
                        <div className="py-1 bg-gradient-to-b from-white/5 to-transparent" role="none">
                            {tournaments.map((t) => (
                                ...
                                >
                                    <span>{t.name}</span>
                                    {t.season === currentSeason && (
                                        <i className="fas fa-check text-xs text-cyan-aura"></i>
                                    )}
                                </button>
                            ))}
                        </div>
