                    ...
                    <table className="w-full uefa-table min-w-[1100px]">
                        <thead>
                            <tr className="bg-gradient-to-r from-gray-50 to-gray-100">
                                ...
                                <th className="p-3 text-center text-uefa-dark border-b border-gray-200" title="Games">{t.stats.gamesShort}</th>
                                <th className="p-3 text-center text-uefa-dark border-b border-gray-200" title="Win-Loss">{t.stats.winLoss}</th>
