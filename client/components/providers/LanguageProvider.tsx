...
const translations = {
    th: {
        ...
        register: {
            ...
            subtitle: 'สร้างบัญชีเพื่อเข้าร่วมทัวร์นาเมนต์',
            ...
            username: 'ชื่อผู้ใช้ (อัตโนมัติ)',
            email: 'อีเมล',
            password: 'รหัสผ่าน',
            confirmPassword: 'ยืนยันรหัสผ่าน',
            applyAdmin: 'สมัครในฐานะ Admin (ต้องรอการอนุมัติ)',
            privacy: 'ต้องการปกปิดข้อมูลส่วนตัว (Encrypt ข้อมูล)',
            submit: 'สมัครสมาชิก',
    ...
    en: {
        ...
        register: {
            ...
            subtitle: 'Create an account to join the competition',
            ...
            applyAdmin: 'Apply for Admin (Requires approval)',
            privacy: 'Private profile (Data encryption)',
            submit: 'Sign Up',
